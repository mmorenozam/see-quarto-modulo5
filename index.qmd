---
title: "Módulo 5: Breve introducción a la Estadística Inferencial en R"
...
# ¡Antes de comenzar por hoy!

## Evaluación del curso hasta el momento

:::incremental

-   Deseo saber tu opinión acerca del curso hasta este momento:

      -   Opinión general del curso (satisfacción, claridad, material)
      
      -   ¿Qué tan novedoso es el curso para ti?
      ...
      -   ¿Qué te hubiese gustado aprender aparte de los contenidos propuestos?
:::

## Evaluación del curso hasta el momento {visibility="uncounted"}

Por favor, ingresa al menti [haciendo click aquí](https://www.menti.com/alybsy8vcxzi){target="_blank"} o con el siguiente código QR:
...
-   Para esta sesión vamos a instalar nuevos paquetes: 
...
## Conceptos básicos de los diseños experimentales
...
-   Como otros números en estadística, proviene de convenciones adoptadas a lo largo del tiempo más que de verdades comprobadas.
...
-   Una ayuda a nuestra disposición para interpretar resultados es el paquete [`report`](https://easystats.github.io/report/){target="_blank"}.
...
## ¿Es $R^2$ realmente útil?

![](images/vieja.jpg){fig-align="center"}

## ¿Es $R^2$ realmente útil? {visibility="uncounted" .smaller}

::: incremental

-   Quizá muchos hayan escuchado que un $R^2$ cercano a 1 es "ideal" cuando realizamos una regresión lineal.

-   Hay incluso márgenes para un buen $R^2$ (algo así como que por encima del 80\% es "bueno", mayor al 90\% es excelente).
...
-   En breve, $R^2$ **NO ES NINGUNA DE LAS SIGUIENTES COSAS**:
    ...
    -   Una métrica que permita comparar modelos usando variables transformadas[: es común jugar a transformar los datos para ver de que manera se puede inflarlo.]{.fragment}
...
-   $R^2$ es simplemente una medida de la cantidad de variación que un modelo específico explica. [¿Tiene alguna utilidad práctica?]{.fragment}
...
-   He visto carnicerías de datos por inflar $R^2$ debido a su mala interpretación de la cual no se sabe su origen exacto ([pero quizá aquí uno de tantos culpables perdidos en la historia](https://psycnet.apa.org/record/1946-01733-001){target="_blank"}).
